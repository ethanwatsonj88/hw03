defmodule PracticeWeb.PageController do
  ...
  def palindrome(conn, %{"phrase" => phrase}) do
    y = Practice.palindrome(phrase)
    render conn, "palindrome.html", phrase: phrase, y: y
  end
  # DONE: Add an action for palindrome.
  # DONE: Add a template for palindrome over in lib/*_web/templates/page/??.html.eex
end
